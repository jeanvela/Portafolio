...
const Gmail = () => {
    return (
        <svg shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="7.086 7.087 1277.149 924.008">
